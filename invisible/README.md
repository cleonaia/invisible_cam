...
Invisible es una pequeña aplicación que usa la cámara para ocultar a una persona del plano, sustituyéndola por el fondo que se ha capturado antes.

La idea es sencilla: primero guardas una imagen del fondo, luego, cuando alzas el puño, la app detecta a la persona y la reemplaza con esa escena para que parezca que desaparece.
...
```bash
cd /Users/leo/Downloads/deleteMe-main
...
La app guarda la imagen de fondo en `bg.jpg` dentro de la carpeta del proyecto.
